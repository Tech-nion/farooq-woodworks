                ...
                >
                  <div className="aspect-[4/3] overflow-hidden relative">
                    ...
                    <button 
                      ...
                      className="absolute top-3 right-3 w-8 h-8 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity hover:bg-primary hover:text-primary-foreground"
                    >
                  ...
                  <div className="p-4">
                    ...
                    {product.worker && (
                      <p className="text-sm text-muted-foreground mt-1">by {product.worker.name}</p>
                    )}
