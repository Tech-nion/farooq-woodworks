          ...
          <div className="relative animate-slide-in-right" style={{ animationDelay: "0.2s" }}>
            <div className="aspect-[4/5] rounded-2xl overflow-hidden shadow-warm">
              <img
                ...
                alt="Master craftsman working on wood"
                className="w-full h-full object-cover"
              />
            </div>
            
            {/* Floating Card */}
            <div className="absolute -bottom-6 -left-6 bg-card rounded-xl p-4 shadow-warm border border-border animate-scale-in" style={{ animationDelay: "0.5s" }}>
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center">
                  <span className="text-2xl">🪵</span>
                </div>
                <div>
                  <div className="font-semibold text-sm">Premium Materials</div>
